...
<html lang="es">
	...
	<body class="claro" style="background-color: #F5F5F5" oncontextmenu="return false;">
	    ...
	    <div id="dlgActualizar" class="easyui-dialog" title="Actualizar" style="width:600px;height:450px;padding:10px"  
            ...
            ">  
         	...
         	<table style="width: 100%" oncontextmenu="return false;">
         		...
         		<tr>
         			<td style="width: 20%" align="right">Imagen : <br><br />Dimensiones <br />(610px x 410px)<br /><br />Peso m&aacute;ximo 100kb</td>
	    ...
	    <div id="dlgNuevo" class="easyui-dialog" title="Registrar" style="width:540px;height:430px;padding:10px"  
            data-options=" 
                buttons: [{  
                    text:'Ok',  
                    iconCls:'icon-ok',  
		...
		<script type="text/javascript" src="controlador/publicidad.js"></script>		
