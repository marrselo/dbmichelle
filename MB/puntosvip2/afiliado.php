...
$arrayMenu=array(
    ...
    ,'establecimientos_afiliados.php'=>'img/establecimientos.jpg');

$contentObj=new detailPage($_GET['establecimiento']);
                            ...
                            <div class="consulta">
                                ...
                                <div class="contenidoWeb">
                                    <div class="afiliados">
                                        <div class="banner">                                            
                                            <div>                                                
                                                <img src="css/images/princess.jpg">
                                                <img src="<?php echo $contentObj->getLogo()?>" 
                                                          style="float:right"> 
                                                         <br />
                                            </div>
                                            <br />
                                            
                                            <img src="<?php echo $contentObj->getBanner()?>" 
                                                 width="432" height="264"> 
                                                <br /><br />
                                            <img src="<?php echo $contentObj->getDcto()?>" 
                                                 width="432" height="49"> 
                                            
                                        </div>
                                        <div>
                                            <p>
                                            <?php echo $contentObj->getText()?>
                                            </p>
                                        </div>
                                    </div>
